...
RegisterNetEvent('qb-vehiclekeys:server:AddItem', function(item, amount)
    local src = source
...
QBCore.Commands.Add("darllaves", Lang:t("addcom.givekeys"), {{name = Lang:t("addcom.givekeys_id"), help = Lang:t("addcom.givekeys_id_help")}}, false, function(source, args)
	local src = source
